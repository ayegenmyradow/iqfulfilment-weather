...
function ClearSunny({ width = 91, height = 95 }) {
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            ...
            <circle
                ...
                stroke="url(#paint1_linear_4_175)"
                strokeWidth="2"
            />
            <mask
                id="mask0_4_175"
            ...
            >
                <path
                    d="M250.729 179.133C250.729 220.061 217.549 253.241 176.62 253.241C135.691 253.241 102.512 220.061 102.512 179.133C102.512 138.204 130.039 147.731 170.968 147.731C211.897 147.731 250.729 138.204 250.729 179.133Z"
                    fill="url(#paint2_linear_4_175)"
                />
            </mask>
            <g mask="url(#mask0_4_175)">
                <g filter="url(#filter1_f_4_175)">
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
            ...
            <defs>
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="50"
                        result="effect1_foregroundBlur_4_175"
                    />
                </filter>
                <filter
                    id="filter1_f_4_175"
