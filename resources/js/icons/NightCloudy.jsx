...
function Clear({ width = 91, height = 95 }) {
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            <g filter="url(#filter0_bdd_4_86)">
                <mask id="path-1-inside-1_4_86" fill="white">
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M212.019 38.1376C215.456 37.5279 217.545 41.5965 215.735 44.5817C206.264 60.2019 204.89 80.2295 213.858 97.6646C225.797 120.875 252.132 131.847 276.348 125.286C279.721 124.373 283.054 127.51 281.513 130.646C275.585 142.715 265.865 153.051 252.989 159.675C221.141 176.056 182.043 163.518 165.662 131.67C149.28 99.8223 161.818 60.7245 193.666 44.3428C199.597 41.2922 205.779 39.2445 212.019 38.1376Z"
                    />
                </mask>
                <path
                    fill-rule="evenodd"
                ...
                />
                <path
                    d="M215.735 44.5817L214.025 43.5448L215.735 44.5817ZM215.637 96.7498C207 79.9584 208.32 60.6692 217.445 45.6186L214.025 43.5448C204.208 59.7346 202.781 80.5007 212.08 98.5794L215.637 96.7498ZM275.825 123.356C252.5 129.675 227.135 119.104 215.637 96.7498L212.08 98.5794C224.459 122.646 251.763 134.019 276.871 127.217L275.825 123.356ZM279.718 129.764C273.973 141.461 264.555 151.476 252.074 157.896L253.904 161.453C267.175 154.627 277.197 143.969 283.308 131.528L279.718 129.764ZM252.074 157.896C221.208 173.772 183.316 161.621 167.44 130.755L163.883 132.585C180.77 165.415 221.074 178.34 253.904 161.453L252.074 157.896ZM167.44 130.755C151.564 99.8897 163.715 61.9977 194.581 46.1214L192.751 42.5643C159.921 59.4512 146.996 99.7548 163.883 132.585L167.44 130.755ZM194.581 46.1214C200.332 43.1633 206.323 41.1792 212.368 40.1069L211.669 36.1684C205.235 37.3098 198.862 39.4212 192.751 42.5643L194.581 46.1214ZM276.871 127.217C277.825 126.958 278.773 127.275 279.359 127.862C279.908 128.411 280.057 129.075 279.718 129.764L283.308 131.528C284.51 129.081 283.762 126.608 282.187 125.033C280.649 123.495 278.244 122.701 275.825 123.356L276.871 127.217ZM217.445 45.6186C218.743 43.4773 218.646 40.9478 217.595 39.0448C216.519 37.0961 214.352 35.6924 211.669 36.1684L212.368 40.1069C213.123 39.973 213.719 40.2988 214.094 40.9783C214.494 41.7034 214.536 42.7009 214.025 43.5448L217.445 45.6186Z"
                    fill="url(#paint1_linear_4_86)"
                    mask="url(#path-1-inside-1_4_86)"
                />
            </g>
            <mask
                id="mask0_4_86"
            ...
            >
                <path
                    d="M303 146C303 178.585 276.585 205 244 205C211.415 205 185 178.585 185 146C185 113.415 206.915 121 239.5 121C272.085 121 303 113.415 303 146Z"
                    fill="url(#paint2_linear_4_86)"
                />
            </mask>
            ...
            <g filter="url(#filter2_bd_4_86)">
                <mask id="path-5-inside-2_4_86" fill="white">
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M265.5 301.997C265.666 301.999 265.833 302 266 302C289.748 302 309 282.748 309 259C309 235.252 289.748 216 266 216C265.833 216 265.666 216.001 265.5 216.003V216H254.391C254.793 213.057 255 210.053 255 207C255 170.549 225.451 141 189 141C152.549 141 123 170.549 123 207C123 210.439 123.263 213.817 123.77 217.115C120.631 216.386 117.361 216 114 216C90.2518 216 71 235.252 71 259C71 282.748 90.2518 302 114 302C114.168 302 114.335 301.999 114.502 301.997L114.5 302H265.5V301.997Z"
                    />
                </mask>
                <path
                    fill-rule="evenodd"
            ...
            <defs>
                ...
                >
                    ...
                    <feComposite
                        in2="SourceAlpha"
                        operator="in"
                        result="effect1_backgroundBlur_4_86"
                    />
                    <feColorMatrix
                        in="SourceAlpha"
                        type="matrix"
                    ...
                    <feBlend
                        mode="normal"
                        in2="effect1_backgroundBlur_4_86"
                        result="effect2_dropShadow_4_86"
                    />
                    <feColorMatrix
                        in="SourceAlpha"
                        type="matrix"
                    ...
                    <feBlend
                        mode="normal"
                        in2="effect2_dropShadow_4_86"
                        result="effect3_dropShadow_4_86"
                    />
                    <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect3_dropShadow_4_86"
                        result="shape"
                    />
                </filter>
                <filter
                ...
                >
                    ...
                    <feGaussianBlur
                        stdDeviation="7"
                        result="effect1_foregroundBlur_4_86"
                    />
                </filter>
                <filter
                    id="filter2_bd_4_86"
